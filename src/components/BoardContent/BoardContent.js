...
import { createNewColumnAPI, updateBoardAPI, updateColumnAPI, updateCardAPI } from 'actions/ApiCall';
...
function BoardContent() {
    ...
    const onCardDrop = (columnId, dropResult) => {
        if (dropResult.removedIndex !== null || dropResult.addedIndex !== null) {
            ...
            if (dropResult.removedIndex !== null && dropResult.addedIndex !== null) {
                ...
                updateColumnAPI(currentColumn._id, newCurrentColumn).catch(() => {
                    flushSync(() => setColumns(originalColumns));
                    flushSync(() => dispatch(updateCurrentFullBoard(newBoard)));
                });
            } else {
    ...
    const onupdateColumnAPIState = (newColumnToUpdate) => {
        ...
        <div className="board-content">
            ...
            >
                <ListColumns
                    ...
                    onupdateColumnAPIState={onupdateColumnAPIState}
                />
            </Container>
