...
function Column(props) {
    const { column, onCardDrop, onupdateColumnAPIState } = props;
    ...
    const onConfirmModalAction = (type) => {
        if (type === MODAL_ACTION_CONFIRM) {
            ...
            updateColumnAPI(newColumn._id, newColumn).then((updatedColumn) => {
                onupdateColumnAPIState(updatedColumn);
            });
        }
    ...
    const addNewCard = () => {
        ...
        createNewCardAPI(newCardToAdd).then((card) => {
            ...
            onupdateColumnAPIState(newColumn);
            setNewCardTitle('');
            ...
            <footer>
                {openNewCardForm && (
                    <div className="add-new-card-actions">
                        <Button className="tqd-send" variant="success" size="sm" onClick={addNewCard}>
                            Add card
                        </Button>
